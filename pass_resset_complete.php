<?php
    ...
    if($newpass == $newpass1){
        ...
        mysqli_query($conn, "UPDATE users SET u_pwd='$enc_pass', passreset='' WHERE u_email='$post_email'");
        //mysqli_query($conn, "UPDATE users SET passreset='0' WHERE email='$post_email'");

        echo"Your password has been updated<p><a href='http://localhost/myshop/signin.php'>Click here to login</a></p>";
